...
public class Jdbc_EmplyeCount {
	...
	public static void main(String[] args) {
		...
		System.out.println("------------------------------------------------------------------");
		try {
			System.out.println("7499 recod details ::"+service.fetchEmployeDetails_byEmpNo(7499));
		}
		catch(DataAccessException dae) {
			dae.printStackTrace();
		}
		...
		try {
			...
			//System.out.println("EMP recod details ::"+service.fetchEmployeDetails_byDesg("CLERK","SALESMAN"));
		
			/*service.fetchEmployeDetails_byDesg("CLERK","SALESMAN").forEach(map->{
		...
		*/
			...
			service.fetchEmployeDetails_byDesg("CLERK","SALESMAN").forEach(System.out::println);//method ref
